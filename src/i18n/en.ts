export default {
  ...
  "Trash": "Trash",
  "What_Time": "What Time?",
  "Household_Garbage_Collection_Time": "Household garbage must be put inside the city-provided container which should be placed at the curb between 6 p.m. the day before and 7 a.m. on the scheduled collection day.",
  ...
  "What_Can_I_Recycle_Details_One": "Newspapers, magazines, glass, and other paper items. Most plastics",
  ...
  "What_About_Glass_Details_One": "The city accepts glass bottles and jars made from clear, green and brown glass. ",
  ...
  "You_Enabled_Reminders_For_Rollout": "You enabled reminders for Rollout!",
  "Sorry_There_Was_A_Problem_Setting_Up_Your_Reminders": "Sorry there was a problem setting up your reminders",
  "We_Had_A_Problem_Loading_Your_Schedule_The_City_Of_Houston_May_Be_Having_Issues": "We Had a Problem Loading Your Schedule. \nThe City of Houston may be having issues",
  "You_Can_Now_Tap_The_Types_Of_Trash_To_Learn_More": "You can now tap the types of trash to learn more!",
  "Looking_Up_Coordinates": "Looking up Coordinates",
  "Unable_To_Locate_You": "Unable to Locate You",
  "Looking_Up_Your_Schedule": "Looking up Schedule",
  ...
  "At_Night": "at night",
  "To_Roll_Out_My_One": "to",
  "To_Roll_Out_My_Two": "roll out",
  "To_Roll_Out_My_Three": "my",
  "Nothing": "nothing",
  "recycling": "recycling",
  "trash": "trash",
  "tree": "tree",
